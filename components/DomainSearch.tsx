...
export default function DomainSearch({ className = '' }: DomainSearchProps) {
  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 mb-4 sm:mb-6 max-w-7xl mx-auto">
      ...
      {isSearching && (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-4 sm:mb-6 max-w-7xl mx-auto">
