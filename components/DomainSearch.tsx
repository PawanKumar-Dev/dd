...
export default function DomainSearch({ className = '' }: DomainSearchProps) {
  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-4 sm:p-4 md:p-6 mb-4 sm:mb-6 w-full max-w-8xl mx-auto">
        ...
        <form onSubmit={handleSearch} className="space-y-3 sm:space-y-4">
          {/* Domain Input */}
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full max-w-full sm:max-w-6xl mx-auto">
            <div className="flex-1">
              <div className="relative group">
                <div className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-blue-50 rounded-lg p-2">
                  <Search className="h-5 w-5 sm:h-4 sm:w-4 text-blue-600" />
                </div>
                <Input
                  id="domain-input"
                  type="text"
            ...
            <div className="flex items-stretch w-full sm:w-auto">
              <Button
                ...
                className="relative w-full sm:w-auto px-8 sm:px-6 py-0 text-base sm:text-sm font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 disabled:from-gray-400 disabled:to-gray-500 text-white border-0 h-14 sm:h-12 flex items-center justify-center transform hover:scale-[1.02] active:scale-[0.98]"
                style={{
